...
def build_project_discovery_report_data(
    ...
    *,
    ...
    return {
        ...
        "active_editor_log_path": str(discovery.get("active_editor_log_path") or ""),
        "newer_foreign_editor_log_detected": bool(discovery.get("newer_foreign_editor_log_detected")),
        "newer_foreign_editor_log_count": int(discovery.get("newer_foreign_editor_log_count") or 0),
