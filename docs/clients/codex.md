...
This guide is pinned to XUUnity release `v0.3.51` from the canonical repository
`https://github.com/FoxsterDev/xuunity-mcp`. Use the matching release README:
`https://github.com/FoxsterDev/xuunity-mcp/blob/v0.3.51/README.md`.
...
1. `unity_status_summary` and require `mcp_server_info.version=0.3.51`
