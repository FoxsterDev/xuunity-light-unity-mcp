...
This guide is pinned to XUUnity release `v0.3.55` from the canonical repository
...
- Required live proof after restart: <server listed, tools listed, unity_status_summary healthy with mcp_server_info.version=0.3.55>
...
1. `unity_status_summary` and require `mcp_server_info.version=0.3.55`
