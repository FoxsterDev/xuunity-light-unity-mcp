...
Last triage: 2026-09-02 (prepared the batch summary-shape false-negative fix for `v0.3.67`; warning/rebuild evidence and the dead `--output` flag remain active)
