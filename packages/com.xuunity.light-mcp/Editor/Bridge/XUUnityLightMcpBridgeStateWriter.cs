    ...
    internal static class XUUnityLightMcpBridgeStateWriter
    {
        ...
        public static void WriteHeartbeat(string lastError = "")
        {
            ...
            var state = new XUUnityLightMcpBridgeState
            {
                ...
                editor_log_offset_at_playmode_start = XUUnityLightMcpEditorLogAnchors.PlayModeStartOffsetBytes,
                editor_log_playmode_started_utc = XUUnityLightMcpEditorLogAnchors.PlayModeStartedUtc,
                editor_log_playmode_anchor_editor_pid = XUUnityLightMcpEditorLogAnchors.PlayModeStartEditorPid,
                editor_log_offset_at_bridge_generation_start = XUUnityLightMcpEditorLogAnchors.BridgeGenerationStartOffsetBytes,
                editor_log_offset_bridge_generation = XUUnityLightMcpEditorLogAnchors.BridgeGenerationForOffset,
                editor_log_bridge_generation_anchor_editor_pid = XUUnityLightMcpEditorLogAnchors.BridgeGenerationStartEditorPid,
